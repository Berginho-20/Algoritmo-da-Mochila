...
// Definições de constantes baseadas no MochilaAG.py
#define N_ITENS 10
#define N_CROMOSSOMOS 150
#define GERACOES 80
...
double calcular_media_fitness(Individuo populacao[]) {
    double soma = 0;
    int validos = 0;
    ...
    return (validos == 0) ? 0 : soma / N_CROMOSSOMOS;
}
...
void evoluir(Individuo populacao[]) {
    Individuo pais[N_CROMOSSOMOS];
    int n_pais = 0;
    ...
    Individuo novos_filhos[N_CROMOSSOMOS];
